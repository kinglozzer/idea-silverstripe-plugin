...
public class QuoteStringFix extends BaseIntentionAction {
    @NotNull
    @Override
    public String getText() {
        return SilverstripeBundle.message("ss.inspection.quote.string.fix");
    }
    ...
    public void invoke(@NotNull final Project project, final Editor editor, final PsiFile file) {
        ...
        document.insertString(range.getEndOffset() + 1, "'");
    }
}
